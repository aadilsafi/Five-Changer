<footer class="footer-section">
    {{-- <div class="footer-top border-top border-bottom has_bg_image"
        data-background="{{ asset('assets/images/bg-four.jpg') }}">
        <div class="footer-top-first">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-5 col-sm-4 text-center text-sm-start">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="footer-widget widget-subscribe">
                            ...
                            <div class="subscribe-part">
                                <p>Subscribe now and receive weekly newsletter for latest draw and offer news
                                    and much more!</p>
