        ...
        <div class="container">
            ...
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-12 text-center mt-2">
                    ...
                    <p class="h5">
                        <b>
                            Jeden Montag: Neue Ziehung bei <span class="text-main h5 m-0">Ad<span class="h5 m-0">Lotto</span></span>
                        </b>
                        <br>
                        <br>
                        Jeden Montag um 12 Uhr gibt es hier auf <span class="text-main h5 m-0">Ad<span class="h5 m-0">Lotto</span></span> eine neue Ziehung. Die Gewinner werden automatisch
                        per
